export default {
  ...
  'form.public.radio.public': '购买',
  'form.public.radio.partially-public': '租赁',
  'form.public.radio.self': '自营',
  'form.public.radio.join': '加盟',
  'form.public.radio.SP': 'SP店',
  'form.method.radio.group': '集团',
  'form.method.radio.store': '单店',
  'form.rule.radio.mode1': '固定还款日',
  'form.rule.radio.mode2': '根据起租日设置还款日',
  'form.rule.radio.mode3': '起租日即还款日',
  'form.channelrule.radio.mode1': '金额',
  'form.channelrule.radio.mode2': '比例',
  'form.channelrule.radio.mode3': '不适用',
  'form.public.radio.settled': '入驻',
